...
index of the string is the value of `.length` minus 1. Use this fact as your
loop condition. Here is a program that counts the number of times the character
`i` appears in the above string.
