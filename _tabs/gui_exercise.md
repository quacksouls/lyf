...
<strong>Exercise 1.</strong> The [viewport][viewport] is that part of a web browser that is currently
...
<!-- prettier-ignore-start -->
<strong>Exercise 2.</strong> The dimensions of the dialog box, and indeed any element in an HTML document,
...
<!-- prettier-ignore-start -->
<strong>Exercise 3.</strong> As shown in the image from the section [Dialog box](../gui_box), the dialog box
...
<!-- prettier-ignore-start -->
<strong>Exercise 4.</strong> When you hover your mouse cursor over the `X` button, you want the cursor to
...
<!-- prettier-ignore-start -->
<strong>Exercise 5.</strong> Carefully observe the image of the dialog box from the section
...
<!-- prettier-ignore-start -->
<strong>Exercise 6.</strong> You want a way to use your mouse to move the dialog box around the viewport. Two
...
[`mouse-event.js`](https://github.com/quacksouls/lyf/blob/main/assets/src/gui/mouse-event.js)
```js
...
<!-- prettier-ignore-start -->
<strong>Exercise 7.</strong> Sam is making a lunch meal plan for the next 5 days. The tentative plan is as
