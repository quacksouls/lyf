...
[`string.js`](https://github.com/quacksouls/lyf/blob/main/assets/src/data/string.js)
```js
/**
...
[`concat.js`](https://github.com/quacksouls/lyf/blob/main/assets/src/data/concat.js)
```js
/**
...
<strong>Exercise 1.</strong> Write a program to introduce yourself. Use variables and template literals to
create strings that contain your full name, age, and favourite food. Print the
strings to the terminal.
<!-- prettier-ignore-end -->

<!-- prettier-ignore-start -->
<strong>Exercise 2.</strong> Run the program below. What are the output of `typeof`? Explain why you got such
output.
<!-- prettier-ignore-end -->

[`type.js`](https://github.com/quacksouls/lyf/blob/main/assets/src/data/type.js)
```js
/**
 * What's my type?
 *
...
<!-- prettier-ignore-start -->
<strong id="exNewline">Exercise 3.</strong> The newline character, written using a backslash as `\n`, can be used to break a
...
[`shopping.js`](https://github.com/quacksouls/lyf/blob/main/assets/src/data/shopping.js)
```js
/**
 * Multiline string.
 *
...
<!-- prettier-ignore-start -->
<strong>Exercise 4.</strong> Read more about JavaScript strings [here][string].
<!-- prettier-ignore-end -->

<!-- prettier-ignore-start -->
<strong>Exercise 5.</strong> Each string has the method [`toLowerCase()`][toLowerCase], which is used to
...
<!-- prettier-ignore-start -->
<strong>Exercise 6.</strong> The function [`ns.tprint()`][tprint] first prints the name of the script that
...
<!-- prettier-ignore-start -->
<strong>Exercise 7.</strong> Tabby Whiskers uses a Linux operating system called Tabian. This is what Tabby's
...
<!-- prettier-ignore-start -->
<strong>Exercise 8.</strong> Use emoji and colours to spice up your terminal output. Colour effect is
...
<!-- prettier-ignore-start -->
<strong>Exercise 9.</strong> Each string in JavaScript has the property [`length`][length], which tells you
...
[`nchar.js`](https://github.com/quacksouls/lyf/blob/main/assets/src/data/nchar.js)
```js
/**
