            ...
            function (e, n, t) {
                !(function (e, t) {
                    ...
                    function (w, R) {
                        ...
                        function S(e, t) {
                            for (
                                var n, r, o, i, a, s = [], u = 0, l = e.length;
                                u < l;
                                u++
                            )
                                (r = e[u]).style &&
                        ...
                        var we = /^(?:checkbox|radio)$/i,
                            ...
                            A =
                                ...
                                (a = C.createElement("input")).setAttribute(
                                    "type",
                                    "radio"
                                ),
                        ...
                        (T.event = {
                            ...
                            dispatch: function (e) {
                                ...
                                if (
                                    ...
                                    !u.preDispatch ||
                                        !1 !== u.preDispatch.call(this, s))
                                ) {
                                    for (
                                        i = T.event.handlers.call(this, s, e),
                                            t = 0;
                                        (r = i[t++]) &&
                        ...
                        function q(n, r, o, i) {
                            ...
                            if (
                                f &&
                                ((t = (e = Ee(r, n[0].ownerDocument, !1, n, i))
                                    .firstChild),
                                1 === e.childNodes.length && (e = t),
                                t || i)
                            ) {
                                for (
                                    s = (a = T.map(N(e, "script"), Ie)).length;
                                    c < f;
                                    c++
                                )
                                    (u = e),
        ...
        13: [
            function (e, t, n) {
                ...
                function d(e) {
                    ...
                    if (
                        ((e = l),
                        0 < (t = [t, n, r, o]).length && 0 < t.filter(e).length)
                    )
                        return 0;
                    for (
                ...
                function b(e, s) {
                    ...
                    if (p && !n) {
                        if (!t)
                            return (
                                s && history.pushState({ path: u }, null, u),
                                h(l)
                            );
                        v = u;
                        n = c
                ...
                function w(e) {
                    var t = c(".book-body")
                        ...
                        t =
                            (x(),
                            t && t[0] && t[0].focus({ preventScroll: !0 }),
                            u());
                    e && t.scrollTop(0),
                        1 <
                        (i = c(".book-summary .summary .chapter").filter(
                            function () {
                    ...
                    s.click(e.onClick),
                        ...
                        (t = e.dropdown
                            ? ((n = u("<div>", {
                              ...
                              (t = o).addClass(
                                  "dropdown-" +
                                      ("right" == e.position ? "left" : "right")
                              ),
                              n.append(t),
                              n)
                            : (s.addClass(a),
                              s.addClass(e.className),
                              s)).addClass("js-toolbar-action"),
